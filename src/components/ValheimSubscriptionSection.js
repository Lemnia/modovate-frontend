...
const valheimTiers = [
  {
    name: 'Explorer',
    price: '$3.99/mo',
    features: ['New biomes', 'Armor reskins', 'Gameplay tweaks'],
    tierId: 'valheim-explorer',
  },
  {
    name: 'Viking Pack',
    price: '$7.49/mo',
    features: ['Weapon expansion', 'Custom mobs', 'Ship upgrades'],
    tierId: 'valheim-viking',
  },
  {
    name: 'Odin’s Legacy',
    price: '$12.99/mo',
    features: ['All Viking Pack items', 'World generators', 'Lore-driven quests', 'Visual enhancements'],
    tierId: 'valheim-odins',
  },
];

const ValheimSubscriptionSection = () => {
    ...
    <section className="bg-[#0b0d10] py-16 px-6 text-white">
      <div className="max-w-6xl mx-auto text-center mb-12">
        <h2 className="text-4xl font-bold mb-4 tracking-wide text-brand-accent">
          Valheim – Subscription Tiers
        </h2>
        <p className="text-gray-300 max-w-2xl mx-auto">
          Conquer Valheim with immersive mods, deep Norse expansions, and visual beauty.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
        {valheimTiers.map((tier, idx) => (
          <div
            key={idx}
...
export default ValheimSubscriptionSection;
