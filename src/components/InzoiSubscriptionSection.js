...
const inzoiTiers = [
  {
    name: 'Creative Boost',
    price: '$3.29/mo',
    features: ['New environment shaders', 'Basic objects', 'UI improvements'],
    tierId: 'inzoi-boost',
  },
  {
    name: 'Expansion Pack',
    price: '$6.79/mo',
    features: ['Interior mod sets', 'Advanced NPC behaviors', 'Music & ambient packs'],
    tierId: 'inzoi-expansion',
  },
  {
    name: 'Zen Master',
    price: '$10.49/mo',
    features: ['All Expansion content', 'Custom animations', 'Cinematic visuals', 'Monthly mega drop'],
    tierId: 'inzoi-zen',
  },
];

const InzoiSubscriptionSection = () => {
    ...
    <section className="bg-[#0b0d10] py-16 px-6 text-white">
      <div className="max-w-6xl mx-auto text-center mb-12">
        <h2 className="text-4xl font-bold mb-4 tracking-wide text-brand-accent">
          Inzoi – Subscription Tiers
        </h2>
        <p className="text-gray-300 max-w-2xl mx-auto">
          Enhance your Inzoi experience with deeply immersive add-ons and aesthetics.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
        {inzoiTiers.map((tier, idx) => (
          <div
            key={idx}
...
export default InzoiSubscriptionSection;
