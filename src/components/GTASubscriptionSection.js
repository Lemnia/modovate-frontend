...
const gtaTiers = [
  {
    name: 'Street Modder',
    price: '$3.49/mo',
    features: ['Custom car skins', 'City style clothing', 'Basic weapon mods'],
    tierId: 'gta-street',
  },
  {
    name: 'Vice Pack',
    price: '$6.99/mo',
    features: ['Vehicle packs', 'Gang AI upgrades', 'Environment textures'],
    tierId: 'gta-vice',
  },
  {
    name: 'Crime Boss',
    price: '$11.99/mo',
    features: ['All Vice Pack content', 'New missions + heists', 'Voice lines & cutscenes', 'Pre-release packs'],
    tierId: 'gta-boss',
  },
];

const GTASubscriptionSection = () => {
    ...
    <section className="bg-[#0b0d10] py-16 px-6 text-white">
      <div className="max-w-6xl mx-auto text-center mb-12">
        <h2 className="text-4xl font-bold mb-4 tracking-wide text-brand-accent">
          GTA V – Subscription Tiers
        </h2>
        <p className="text-gray-300 max-w-2xl mx-auto">
          Take over the streets with high-quality mods for GTA V. From vehicles to story enhancements.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
        {gtaTiers.map((tier, idx) => (
          <div
            key={idx}
...
export default GTASubscriptionSection;
